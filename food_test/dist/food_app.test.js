...
describe('Food クラスのテスト', () => {
    ...
    test('初期スコアが0であること', () => {
        // テストで使用するDOMエレメントを取得
        const foodElements = Array.from(global.document.querySelectorAll('.food'));
        const scoreElement = global.document.querySelector('.score__number');
        //console.log(scoreElement);
        expect(scoreElement).not.toBeNull();
        expect(scoreElement === null || scoreElement === void 0 ? void 0 : scoreElement.textContent).toBe('0');
    });
...
//# sourceMappingURL=food_app.test.js.map